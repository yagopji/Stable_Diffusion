...
options_templates.update(options_section(('ui', "User interface", "ui"), {
    ...
    "translate_korean_prompts": OptionInfo(True, "Automatically translate Korean prompts to English").info("when prompt contains Korean (Hangul), translate to English before generation"),
